const errorCode = {
  ...
  3040: {
    eng: 'File not exist data.',
    vie: 'File không có dữ liệu',
  },

  5019: {
    eng: 'List call data is empty.',
    vie: 'Danh sách dữ liệu cuộc gọi trống',
  },
  ...
  3039: {
    eng: 'File upload wrong format',
    vie: 'File tải lên không hợp lệ',
  },
  ...
  9000: {
    eng: 'Export time is not more than 30 days !!!',
  },

  8001: {
    eng: 'Invalid nodes number',
    vie: 'Số node không hợp lệ',
  },

  8002: {
    eng: 'Agent is required to have password and branch number',
    vie: 'Agent bắt buộc phải có mật khẩu và số extension',
  },

  8003: {
    eng: 'Queue name is existed!!!',
    vie: 'Tên queue đã tồn tại',
  },

  8004: {
    eng: 'Extention is exitsted!!!',
    vie: 'Extension đã tồn tại',
  },

  8005: {
    eng: 'Agents cannot have 2 extensions in queue!!!',
    vie: 'Agent không thể có 2 extension trong queue',
  },

  8006: {
    eng: 'Queue not found',
    vie: 'Queue không tồn tại',
  },

  8007: {
    eng: 'Extention not found',
    vie: 'Extention không tồn tại',
  },

  8008: {
    eng: 'Configuration info is required of agent node',
    vie: 'Node agent bắt buộc cấu hình thông tin info',
  },

  8009: {
    eng: 'Bot node required have field info',
    vie: 'Bot node bắt buộc cấu hình thông tin info',
  },

  1011: {
    eng: 'Phone number is not valid',
    vie: 'SDT không hợp lệ',
  },

  4023: {
    eng: 'Limit upload file is 15 file/minute',
    vie: 'Giới hạn tải file lên là 15 file/phút',
  },

  4024: {
    eng: 'Sample Script Name already existed',
    vie: 'Tên kịch bản mẫu đã có ',
  },

  8010: {
    eng: 'User not mapping agent !!!',
    vie: 'Người dùng này không phải agent',
  },

  8011: {
    eng: 'User not exist !!!"',
    vie: 'Tài khoản không tồn tại',
  },
};
